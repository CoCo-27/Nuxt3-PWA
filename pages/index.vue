<template>
  <div
    class="flex flex-col desktop:flex-row justify-center items-center gap-[2rem] p-[2rem] bg-[#f5f5f5] w-full min-h-screen"
  >
    <div
        ...
        >
          ...
          >
            <div class="justify-start items-center gap-2 flex">
              ...
              >
                <div class="text-yellow-500 text-[8px] font-normal">
                  Versandt
                </div>
              </div>
              <div class="text-zinc-800 text-base font-bold">
    ...
    >
      ...
      >
        <div
          class="self-stretch justify-between items-center gap-1 inline-flex"
        >
      ...
      <div class="w-full px-4 justify-center items-center inline-flex">
        <div
          class="bg-white rounded-[100px] w-full px-4 py-2 gap-2 inline-flex"
        >
          <div class="w-6 h-6 relative">
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <div class="self-stretch justify-between items-center gap-2 inline-flex">
        ...
        <div class="justify-start items-center gap-2 flex">
          <div
            class="bg-white rounded-2xl justify-start items-center gap-1 flex"
          >
            <div class="w-6 h-6 relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <div
        class="self-stretch h-[500px] flex-col justify-start items-start gap-4 flex"
      >
        <div
          class="self-stretch px-4 py-3 bg-black bg-opacity-5 rounded-[100px] justify-center items-center gap-2 inline-flex"
        >
          <div class="text-black text-opacity-75 text-xs font-bold">
            Patient:
          </div>
          <div class="grow shrink basis-0 text-black text-sm font-normal">
            search
        ...
        <div
          class="self-stretch px-4 py-3 bg-black bg-opacity-5 rounded-[100px] justify-center items-center gap-2 inline-flex"
        >
          <div class="w-[57px] text-black text-opacity-75 text-xs font-bold">
            Rd zu Bp:
          </div>
          <div class="grow shrink basis-0 text-black text-sm font-normal">
            Datepicker
